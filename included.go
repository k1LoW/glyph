...
var Included = Set{
	"db": NewSub().Lines([]LineAndOpts{
		"b0 d0 h0 j0 j6 h8 d8 b6 b0",
		"b0 d2 h2 j0",
		"b2 d4 h4 j2",
		"b4 d6 h6 j4",
	}),
	"doc": NewSub().Lines([]LineAndOpts{
		"b0 b5 f9 f4 b0",
	...
	"browser": NewSub().Lines([]LineAndOpts{
		"d0 d5 i7 i2 d0",
		"d1 i3",
		"e1 e2",
		"f2 f3",
	...
	"cube": NewSub().Lines([]LineAndOpts{
		"f1 b1 b5 f9 j5 j1 f1",
		"c2 f5",
		"f5 f8",
		"g4 j1",
	}),
	"lb": NewSub().Lines([]LineAndOpts{
	...
	"terminal": NewSub().Lines([]LineAndOpts{
	...
	"proxy": NewSub().Lines([]LineAndOpts{
	...
	"lb-l4": NewSub().Lines([]LineAndOpts{
		"b4 a4 a5 b6 c6 c5 b4",
		"g0 f1 f2 g2 h1 h0 g0",
		"j3 i4 i5 j5 k4 k3 j3",
		"c5 d5 d2 f2",
	...
	"lb-l7": NewSub().Lines([]LineAndOpts{
		"b4 a4 a5 b6 c6 c5 b4",
		"g0 f1 f2 g2 h1 h0 g0",
		"j3 i4 i5 j5 k4 k3 j3",
		"c5 d5 d2 f2",
